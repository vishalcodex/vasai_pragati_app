          ...
          child: RoundedContainer(
            ...
            child: Column(
              children: [
                Expanded(
                  child: MyListView(
                    ...
                    children: [
                      MyListView(
                        children: [
                          pageName.aliasName!.trim() == "LN1"
                              ? const PersonalLoansView()
                              : pageName.aliasName!.trim() == "LN2"
                                  ? const SecuredLoansView()
                                  : pageName.aliasName!.trim() == "LN3"
                                      ? const GoldLoansView()
                                      : pageName.aliasName!.trim() == "LN4"
                ...
                Obx(
                  () => controller.selectedAccount.value.transactions.isNotEmpty
                      ? Container(
