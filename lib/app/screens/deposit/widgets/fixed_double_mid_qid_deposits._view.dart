...
class FixedDoubleMIDQIDDepositsView extends GetView<DepositController> {
  const FixedDoubleMIDQIDDepositsView({super.key});
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: controller
                                      ...
                                      : TextView(
                                          text:
                                              "₹ ${controller.selectedAccount.value.fdMaster!.pROVISIONS}",
                                          alignment: TextAlign.right,
                                          color: ColorPallete.secondary,
                                          fontSize: 16,
                                        ),
